...
namespace _19_atividade_CRUD.Controllers
{
    ...
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("categoriaId,CategoriaNome,Sinopse")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("categoriaId,CategoriaNome,Sinopse")] Categoria categoria)
        {
