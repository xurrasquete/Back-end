...
namespace Projeto_Aulas.Areas.Admin.Controllers
{
    ...
    public class ClienteController : Controller
    {
       ...
       public async Task<IActionResult> Details(int? id)
        ...
        public async Task<IActionResult> Create([Bind("ClienteID,Nome,DatadeNascimento,Email,Cep,Rua,Bairro,Cidade,Estado,Numeros,Complemento,Senha")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteID,Nome,DatadeNascimento,Email,Cep,Rua,Bairro,Cidade,Estado,Numeros,Complemento,Senha")] Cliente cliente)
        {
